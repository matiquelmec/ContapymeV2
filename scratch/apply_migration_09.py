...
def main():
    print("Aplicando Migración 09...")
    with open("supabase/migrations/09_migration_robust_rpc_resolution.sql", 'r', encoding='utf-8') as f:
        sql = f.read()
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
            print("Migración 09 aplicada con éxito!")
        conn.close()
