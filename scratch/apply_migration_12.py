...
def main():
    print("Aplicando Migración 12 (Hardening RLS)...")
    with open("supabase/migrations/12_migration_rls_hardening.sql", 'r', encoding='utf-8') as f:
        sql = f.read()
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
            print("Migración 12 aplicada con éxito!")
        conn.close()
