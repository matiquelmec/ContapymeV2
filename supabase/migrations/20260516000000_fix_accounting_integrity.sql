...
-- Fecha: 2026-05-16
-- Objetivo: Garantizar que cada línea de asiento tenga account_id y 
--          organization_id resolviéndolos automáticamente por código.
--          Esto soluciona el problema de Dashboards en $0.
-- ============================================================

-- 1. Actualizar rpc: create_journal_entry_with_lines
...
BEGIN
    ...
    -- 2. Insertar las líneas resolviendo el ID de cuenta automáticamente
...
-- 2. Actualizar rpc: batch_create_journal_entries
...
BEGIN
    ...
    LOOP
        ...
        -- 2. Insertar las líneas con resolución de ID
