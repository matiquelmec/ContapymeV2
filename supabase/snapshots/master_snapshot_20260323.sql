...
-- SINCRO FINAL: 2026-03-24 (Onboarding Patch + Sincro Total Sincro Maestro 🛡️💎)
...
CREATE TABLE public.payroll_book_details (
  ...
  CONSTRAINT payroll_book_details_employee_id_fkey KEY (employee_id) REFERENCES public.employees(id)
);
