...
class DTELogic:
    ...
    async def retry_send_to_sii(self, dte_id: str) -> Dict[str, Any]:
        ...
        if is_boleta and ("RznSocEmisor" not in xml_content or "Acteco" in xml_content or "GiroRecep" in xml_content or "TasaIVA" in xml_content or "TmstFirma" not in xml_content):
