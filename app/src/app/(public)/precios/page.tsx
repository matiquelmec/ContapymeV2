    ...
    <AuroraBackground className="py-16 sm:py-24 scroll-mt-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/5 border border-primary/20 text-primary text-[10px] font-black uppercase tracking-[0.3em]">
            <ShieldCheck className="w-3.5 h-3.5" /> Inversión Estratégica Transparente
          </div>
          <h1 className="text-4xl sm:text-6xl font-black italic tracking-tighter uppercase text-foreground leading-[0.9]">
            Planes Diseñados <br />
