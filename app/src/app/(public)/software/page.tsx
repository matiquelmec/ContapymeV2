        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Users, title: "Remuneraciones LRE", desc: "Emite liquidaciones masivas de sueldo con exenciones de zona extrema. Genera el Libro de Remuneraciones Electrónico listo para la Dirección del Trabajo (DT).", cta: "Gestionar Sueldos" },
