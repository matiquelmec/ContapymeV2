...
export default function LiquidationDetailPage() {
  ...
  const buildPDFDocument = (): jsPDF => {
    ...
    doc.text(`Dirección: ${organization?.direccion || ''}, ${organization?.comuna || ''}`, 20, 36)
    ...
    // Firmas (solo en el documento impreso/PDF)
    y += 40
    doc.setLineWidth(0.2)
    doc.line(30, y, 90, y); doc.line(120, y, 180, y)
