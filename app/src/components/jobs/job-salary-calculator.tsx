...
export function JobSalaryCalculator({ initialGrossSalary, salaryRaw }: JobSalaryCalculatorProps) {
  ...
  return (
    <div className="p-7 sm:p-8 rounded-[2.5rem] bg-gradient-to-br from-zinc-900 to-zinc-950 text-white shadow-2xl space-y-6 border border-zinc-800">
      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 h-12 rounded-xl bg-zinc-800/80 border-zinc-700 text-white font-mono text-sm focus-visible:ring-emerald-400"
          />
        </div>
      </div>

      {/* Desglose de Descuentos Legales */}
      <div className="p-5 rounded-2xl bg-zinc-900/90 border border-zinc-800/80 space-y-3 text-xs">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-emerald-950/80 to-zinc-900 border border-emerald-500/30 flex items-center justify-between">
        <div>
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-400">
            Sueldo Líquido Estimado en Bolsillo
          </span>
          <p className="text-2xl sm:text-3xl font-black text-white italic tracking-tight tabular-nums">
