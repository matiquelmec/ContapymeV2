    ...
    <>
      {!isInstalled && (
        <Button
          ...
          className="rounded-xl border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-800 hover:text-emerald-950 font-black text-[10px] uppercase tracking-wider h-8 px-3 gap-1.5 shadow-sm transition-all hover:scale-105 active:scale-95 cursor-pointer"
